...
class StoryList {
  ...
  static async getStories() {
    ...
    //  instance method?
    // ALL INSTANCES OF STORYLIST SHOULD SHARE THIS CODE - can be easily called without the instance
    // SINCE IT ALWAYS REFERS TO THE SAME StoryList RETRIEVED FROM THE API - don't need to replicate it across instances
    // UTILITY FUNCTION TO CLONE THE API - want it to run whenever a new post is made to update StoryList
    // CAN CALL THE METHOD BEFORE CREATING StoryList 
